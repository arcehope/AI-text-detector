...
# 1. BLACK AND WHITE DRAW.IO XML CONTENT
DRAWIO_BW_XML = '''<mxfile host="app.diagrams.net" modified="2026-08-17T20:51:00.000Z" agent="Antigravity" version="21.6.8" type="device">
  <diagram id="sequence-diagram-fig36-bw" name="Figure 3.6 Sequence Diagram (B&amp;W)">
    <mxGraphModel dx="1000" dy="900" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="1" pageScale="1" pageWidth="960" pageHeight="880" math="0" shadow="0">
      <root>
        ...
        <!-- Figure Title -->
        <mxCell id="title" value="&lt;b style=&quot;font-family: Georgia, 'Times New Roman', serif; font-size: 18px; color: #000000;&quot;&gt;Figure 3.6: Sequence Diagram for AI Text Detector&lt;/b&gt;" style="text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;" vertex="1" parent="1">
          <mxGeometry x="230" y="20" width="500" height="35" as="geometry" />
        </mxCell>

        <!-- PARTICIPANT HEADERS (Black & White) -->
        <!-- 1. Client Header -->
        <mxCell id="header_client" value="Client" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#000000;strokeWidth=2;fontColor=#000000;fontStyle=1;fontSize=15;align=center;verticalAlign=middle;arcSize=20;" vertex="1" parent="1">
          <mxGeometry x="75" y="70" width="150" height="55" as="geometry" />
        </mxCell>

        <!-- 2. Server Header -->
        <mxCell id="header_server" value="Server" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#000000;strokeWidth=2;fontColor=#000000;fontStyle=1;fontSize=15;align=center;verticalAlign=middle;arcSize=20;" vertex="1" parent="1">
        ...
        <!-- 4. Database Header -->
        <mxCell id="header_db" value="Database" style="rounded=1;whiteSpace=wrap;html=1;fillColor=#FFFFFF;strokeColor=#000000;strokeWidth=2;fontColor=#000000;fontStyle=1;fontSize=15;align=center;verticalAlign=middle;arcSize=20;" vertex="1" parent="1">
          <mxGeometry x="775" y="70" width="150" height="55" as="geometry" />
        </mxCell>

        <!-- LIFELINES (Black lines) -->
        ...
        <!-- ACTIVATION BARS (White fill, Black stroke) -->
        ...
        <!-- LOOP CONTAINER FRAGMENT (Black border) -->
        ...
        <!-- MESSAGES & NUMBERED BADGES (Black & White) -->
...
# 2. BLACK AND WHITE STANDALONE SVG CONTENT
SVG_BW_CONTENT = '''<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 880" width="100%" height="100%" style="background-color: #ffffff;">
  <defs>
  ...
  <style>
    ...
    .header-box-text { font-family: 'Helvetica Neue', Arial, sans-serif; font-size: 15px; font-weight: bold; fill: #000000; text-anchor: middle; }
  ...
  <!-- Activation Bars (White background, Black outline) -->
  <!-- Server Activation Bar -->
  <rect x="371" y="160" width="18" height="630" rx="3" fill="#ffffff" stroke="#000000" stroke-width="1.5" />
  <!-- Scanner Engine Activation Bar -->
  ...
  <text x="150" y="103" class="header-box-text">Client</text>

  <!-- 2. Server -->
  <rect x="305" y="70" width="150" height="55" rx="10" ry="10" fill="#ffffff" stroke="#000000" stroke-width="2" />
  <text x="380" y="103" class="header-box-text">Server</text>
  ...
  <text x="850" y="103" class="header-box-text">Database</text>
...
def main():
    ...
    for d in target_dirs:
        ...
        # Write B&W .drawio XML
        drawio_path = os.path.join(d, 'sequence_diagram_bw.drawio')
        with open(drawio_path, 'w', encoding='utf-8') as f:
            f.write(DRAWIO_BW_XML)

        # Overwrite standard drawio with B&W version as well
        with open(os.path.join(d, 'sequence_diagram.drawio'), 'w', encoding='utf-8') as f:
            f.write(DRAWIO_BW_XML)

        # Write B&W .svg
        svg_path = os.path.join(d, 'sequence_diagram_bw.svg')
        with open(svg_path, 'w', encoding='utf-8') as f:
            f.write(SVG_BW_CONTENT)

        # Overwrite standard svg with B&W version as well
        with open(os.path.join(d, 'sequence_diagram.svg'), 'w', encoding='utf-8') as f:
            f.write(SVG_BW_CONTENT)

        print(f"Written B&W assets to: {d}")
