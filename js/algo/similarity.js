...
class CosineSimilarityAnalyzer {
    ...
    extractStylometricProfile(text) {
        ...
        // Normalize: mapping 0% to 0.0, and 2.5%+ to 1.0
        const valTransitions = Math.min(1.0, transitionRatio / 0.025);
        ...
        // Normalize: mapping 0% to 0.0, and 3%+ to 1.0
        const valIntensifiers = Math.min(1.0, intensifierRatio / 0.03);
